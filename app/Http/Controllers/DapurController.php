...
class DapurController extends Controller
{
    public function index()
    {
        ...
        // DATA TAMBAHAN UNTUK DASHBOARD STAFF DAPUR
        // Produksi hari ini oleh user yang login
       $myProductionToday = Production::where('user_id', $user->id)
    ->whereDate('created_at', today())
    ->sum('quantity_produced');
        
        // Produksi terbaru (5 terakhir)
    ...
    ->get();
        ...
        // Stok menipis list
        $lowStockList = Ingredient::whereColumn('stock_quantity', '<=', 'minimum_stock')
